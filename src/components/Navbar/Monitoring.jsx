  ...
  return (
    <div className='flex text-white justify-evenly p-6 flex-wrap'>
        <div className='bg-slate-800/50 rounded-md shadow-md p-6 w-80 border border-slate-700 h-25 flex items-center'>
            <div><Activity  className="size-7 text-green-400" /></div>
            <div className='ml-4'> 
        ...
        <div className='bg-slate-800/50 rounded-md shadow-md p-6 w-80 border border-slate-700 h-25 flex items-center'>
            <div><Users className="size-7 text-blue-400" /></div>
            <div className='ml-4'>
        ...
        <div className='bg-slate-800/50 rounded-md shadow-md p-6 w-80 border border-slate-700 h-25 flex items-center'>
            <div><Zap className="size-7 text-yellow-400" /></div>
            <div className='ml-4'>
        ...
        <div className='bg-slate-800/50 rounded-md shadow-md p-6 w-80 border border-slate-700 h-25 flex items-center'>
            <div><TrendingUp className="size-7 text-emerald-400" /></div>
            <div className='ml-4'>
